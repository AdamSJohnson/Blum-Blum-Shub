...
#l bits long
def generate_random_bits(n_bits, l, c=1):
    if math.floor(l/c) != math.ceil(l/c):
        print('l/c must be an integer value')
        return -1
    ...
    i = 1
    #grab the c LSBs of x and append it to z
    z = z | (x[0] & ((pow(2, c)-1)))
    while i < math.floor(l/c):
